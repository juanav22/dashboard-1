...
function App() {
  ...
  React.useEffect(() => {
    async function fetchKpiData() {
      const response = await fetch(`http://localhost:${PORT}/kpi`);
  ...
  React.useEffect(() => {
    async function fetchSalesData() {
      const response = await fetch(`http://localhost:${PORT}/sales`);
      const data = await response.json();
  ...
  React.useEffect(() => {
    async function fetchTrafficData() {
      const response = await fetch(`http://localhost:${PORT}/traffic`);
      const data = await response.json();
